 ...
 * 
 * Time-bucketed aggregation of download-related activity events per download group.
 * Enables efficient per-download analytics and pattern detection.
 * 
 * @property int $id
 ...
 */
class DownloadEventAggregate extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'download_event_aggregates';
    ...
    /**
     * Get the download this aggregate is for.
     */
