...
class AccountCanceled extends BaseMailable
{
    ...
    public function __construct(Tenant $tenant, User $user, User $admin)
    {
        ...
        $this->template = NotificationTemplate::getByKey('account_canceled');
    }
    ...
    public function envelope(): Envelope
    {
        ...
        $subject = $this->template 
            ...
            : "Your account has been canceled - {$this->tenant->name}";
