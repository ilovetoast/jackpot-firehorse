...
class BillingCompedExpiringWarning extends BaseMailable
{
    ...
    public function __construct(Tenant $tenant, User $owner, Carbon $expirationDate, int $daysUntilExpiration)
    {
        ...
        $this->template = NotificationTemplate::getByKey('billing_comped_expiring_warning');
    }
    ...
    public function envelope(): Envelope
    {
        ...
        $subject = $this->template 
            ...
            : "Your complimentary plan expires in {$this->daysUntilExpiration} days - {$this->tenant->name}";
    ...
    public function content(): Content
    {
        ...
        return new Content(
            view: 'emails.billing-comped-expiring-warning',
            with: [
                'tenant' => $this->tenant,
                'owner' => $this->owner,
