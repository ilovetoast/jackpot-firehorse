...
class BillingTrialExpired extends BaseMailable
{
    ...
    public function __construct(Tenant $tenant, User $owner, $expirationDate = null)
    {
        ...
        $this->template = NotificationTemplate::getByKey('billing_trial_expired');
    }
    ...
    public function envelope(): Envelope
    {
        ...
        $subject = $this->template 
            ...
            : "Your trial has expired - {$this->tenant->name}";
