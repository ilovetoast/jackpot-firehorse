...
class BrandGuidelinesBuilderTest extends TestCase
{
    ...
    public function test_run_brand_research_job_links_insight_state_to_snapshot(): void
    {
        ...
        $this->assertSame($snapshot->id, $insightState->source_pipeline_snapshot_id, 'Insight state must link to snapshot');
    }
    ...
    // Old vision pipeline tests removed (test_pdf_vision_fallback_triggers_when_text_empty,
    // test_parallel_page_processing_merges_results, test_page_analysis_persistence_through_merge_and_ingestion,
    // test_early_exit_stops_remaining_jobs, test_processing_dashboard_returns_page_progress,
    // test_cannot_proceed_while_any_source_processing) — replaced by Claude single-pass extraction.
