...
class PdfPageWorkflowTest extends TestCase
{
    ...
    public function test_pdf_page_endpoint_returns_ready_with_url_when_page_exists(): void
    {
        ...
        $deliveryServiceMock->shouldReceive('getPdfPageUrl')
            ->with(Mockery::type(\App\Models\Asset::class), 2, Mockery::any())
            ->andReturn('https://cdn.example.com/pdf_pages/page-2.webp');
