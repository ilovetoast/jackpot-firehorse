...
See the **Merged phase reference: AI metadata generation** appendix in this file for the complete Phase I design.
...
# Merged phase reference: AI metadata generation (design) and tenant AI capabilities

The following sections preserve `PHASE_I_AI_METADATA_GENERATION.md` and `admin/ai/phase-7-5-tenant-ai-capabilities.md` in full.


## Source: PHASE_I_AI_METADATA_GENERATION.md
...
## Source: admin/ai/phase-7-5-tenant-ai-capabilities.md
