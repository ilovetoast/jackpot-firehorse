 ...
 *
 * Opt-in folders (is_hidden=true on template): new taxonomy slugs start hidden in the library; tenants surface them
 * from Manage → Categories (“Available from catalog” / hidden list) or toggle visibility. Core slugs stay visible.
 */
