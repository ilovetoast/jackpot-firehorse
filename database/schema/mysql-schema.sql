...
CREATE TABLE `brand_user` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `brand_user_brand_id_user_id_unique` (`brand_id`,`user_id`),
...
CREATE TABLE `brands` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `brands_tenant_id_index` (`tenant_id`),
...
CREATE TABLE `categories` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `category_unique_slug` (`tenant_id`,`brand_id`,`asset_type`,`slug`),
  KEY `categories_tenant_id_index` (`tenant_id`),
  KEY `categories_brand_id_index` (`brand_id`),
  KEY `categories_asset_type_index` (`asset_type`),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2026_01_04_201917_create_permission_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2026_01_04_203704_create_tenants_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2026_01_04_203705_create_brands_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2026_01_04_203705_create_tenant_user_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2026_01_04_203801_add_cashier_columns_to_tenants_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (9,'2026_01_04_222538_add_brand_fields_to_brands_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (14,'2026_01_05_002359_create_subscriptions_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (15,'2026_01_05_002400_create_subscription_items_table',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (16,'2026_01_05_002401_add_meter_id_to_subscription_items_table',4);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (17,'2026_01_05_002402_add_meter_event_name_to_subscription_items_table',5);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (18,'2026_01_05_140000_add_timezone_to_tenants_table',6);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (19,'2026_01_04_224755_add_settings_to_brands_table',7);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (20,'2026_01_05_013011_create_brand_user_table',8);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (21,'2026_01_05_013214_add_profile_fields_to_users_table',9);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (22,'2026_01_05_005922_add_first_name_last_name_to_users_table',10);
