...
Route::middleware(['auth', 'ensure.account.active', ImpersonationMiddleware::class, 'collect.asset_url_metrics', 'log.cloudfront.403'])->prefix('app')->group(function () {
    ...
    Route::post('/admin/companies/{tenant}/stripe-invoices/{invoice}/void', [\App\Http\Controllers\SiteAdminController::class, 'voidTenantStripeInvoice'])
        ->where('invoice', 'in_[A-Za-z0-9]+')
        ->name('admin.companies.stripe-invoices.void');
    ...
    // Onboarding flow (tenant-scoped, exempt from onboarding redirect) — company admins only
    Route::middleware(['tenant', 'tenant.admin.brand_setup'])->group(function () {
    ...
    Route::middleware(['tenant', \App\Http\Middleware\RestrictCollectionOnlyUser::class])->group(function () {
        ...
        Route::middleware(['ensure.user.within.plan.limit', \App\Http\Middleware\EnsureOnboardingComplete::class])->group(function () {
            ...
            Route::post('/assets/{asset}/original/rotate', [\App\Http\Controllers\AssetController::class, 'rotateOriginal'])->name('assets.original.rotate');
            ...
            Route::get('/brand-guidelines', [\App\Http\Controllers\BrandGuidelinesController::class, 'redirectToActive'])
                ->middleware('tenant.admin.brand_setup')
                ->name('brand-guidelines.index');
            ...
            Route::middleware(['tenant.admin.brand_setup'])->group(function () {
