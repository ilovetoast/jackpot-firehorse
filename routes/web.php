...
Route::middleware(['auth', 'ensure.account.active'])->prefix('app')->group(function () {
    ...
    Route::middleware(['tenant', \App\Http\Middleware\RestrictCollectionOnlyUser::class])->group(function () {
        ...
        Route::middleware('ensure.user.within.plan.limit')->group(function () {
            ...
            Route::get('/assets/{asset}/pdf-page/{page}', [\App\Http\Controllers\PdfPageController::class, 'show'])
                ->whereNumber('page')
                ->name('assets.pdf-page.show');
            Route::post('/assets/{asset}/pdf/extract-all', [\App\Http\Controllers\PdfPageController::class, 'extractAll'])
                ->name('assets.pdf.extract-all');
