...
export default function PublicReplyForm({ ticketId }) {
    ...
    const handleSubmit = (e) => {
        ...
        post(`/app/admin/support/tickets/${ticketId}/reply`, {
            forceFormData: true,
            preserveScroll: true,
            onSuccess: () => {
                reset()
    ...
    return (
        <div className="border border-gray-200 rounded-lg p-4 bg-white">
            <h4 className="text-sm font-semibold text-gray-900 mb-3">Add Public Reply</h4>
            <p className="text-xs text-gray-500 mb-3">This reply will be visible to the tenant.</p>
