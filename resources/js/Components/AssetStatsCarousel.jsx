...
export default function AssetStatsCarousel({ 
    ...
    const [activeTab, setActiveTab] = useState('viewed') // 'viewed' or 'downloaded'
    ...
    // Sort by views/downloads (descending) and take top items
    ...
    if (mostViewedAssets.length === 0 && mostDownloadedAssets.length === 0) {
        return (
                ...
                {displayAssets.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                        ...
                        <p className="mt-2 text-sm text-gray-500">
                            No {activeTab === 'viewed' ? 'views' : 'downloads'} yet
                        </p>
                    </div>
                )}
            </div>
