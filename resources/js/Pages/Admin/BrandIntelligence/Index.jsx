...
export default function BrandIntelligenceIndex({ auth, rows }) {
                            ...
                            <tbody className="divide-y divide-slate-100">
                                ...
                                {data.map((row) => (
                                    <tr key={row.asset_id} className="hover:bg-slate-50/80">
                                        ...
                                        <td className="px-4 py-3 text-xs font-mono text-slate-600 max-w-[14rem] truncate" title={row.engine_version}>
                                            {row.engine_version ?? '—'}
                                        </td>
