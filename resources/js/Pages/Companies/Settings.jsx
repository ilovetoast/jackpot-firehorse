...
export default function CompanySettings({
    ...
    const persistDownloadPolicy = (next) => {
        if (!hasDownloadPolicyAccess) return
            ...
            <main className="flex-1">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 sm:py-7">
                    ...
                    <div id="company-information" className="mb-12 scroll-mt-8">
                        ...
                        <div className="overflow-hidden rounded-lg border border-slate-200/90 bg-white shadow-sm ring-1 ring-slate-100/50">
                            ...
                            <div className="space-y-6">
                                ...
                                {['pro', 'premium', 'enterprise'].includes(billing.current_plan) && (
                    ...
                    <div id="enterprise-download-policy" className="mb-12 scroll-mt-8">
                        {hasDownloadPolicyAccess && !canManageDownloadPolicy ? (
                            <div className="overflow-hidden rounded-lg bg-white shadow-sm ring-1 ring-gray-200">
                                <div className="relative">
                                    <div className="blur-sm select-none pointer-events-none">
                                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                                            ...
                                            <div className="mt-4 space-y-5">
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        {!hasDownloadPolicyAccess && <p className="mt-1 text-xs text-gray-400">Included with Premium or Enterprise plan.</p>}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div id="metadata-settings" className="mb-12 scroll-mt-8">
                            <div className="overflow-hidden rounded-lg bg-white shadow-sm ring-1 ring-gray-200">
                                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                                    {/* Left: Header */}
                                    <div className="lg:col-span-1 px-6 py-6 border-b lg:border-b-0 lg:border-r border-gray-200">
                                        <h2 className="text-lg font-semibold text-gray-900">Folders & filters</h2>
                                        <p className="mt-1 text-sm text-gray-500">Define how content is organized—use Manage → Folders & filters for the active brand</p>
                                    </div>
                                    {/* Right: Content */}
                                    <div className="lg:col-span-2 px-6 py-6">
                                        <div className="space-y-4">
                                            <div>
                                                <p className="text-sm text-gray-700 mb-4">
                                                    Open Manage → Folders & filters to configure folders, metadata filters, and where they appear on upload, edit, and filters.
                                                </p>
                                                <Link
                                                    href={
                                                        typeof route === 'function'
                                ...
                                >
                                    ...
                                    <div className="overflow-hidden rounded-lg bg-white shadow-sm ring-1 ring-gray-200">
                                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                                            ...
                                            <div className="lg:col-span-2 px-6 py-6">
                                                <AiTaggingSettings canEdit={canManageAiSettings} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
