            ...
            <div className="flex flex-1 overflow-hidden" style={{ height: 'calc(100vh - 5rem)' }}>
                ...
                <div className="flex-1 overflow-y-auto bg-gray-50 h-full">
                    <div className="py-6 px-4 sm:px-6 lg:px-8">
                        {/* Marketing Assets Content - Placeholder for now */}
                        <div className="p-12 text-center">
                            <SparklesIcon className="mx-auto h-12 w-12 text-gray-400" />
                            <h3 className="mt-2 text-sm font-semibold text-gray-900">No marketing assets</h3>
                            <p className="mt-1 text-sm text-gray-500">
                                {selectedCategoryId
                                    ? 'Get started by uploading your first marketing asset to this category.'
                                    : 'Get started by selecting a category or uploading your first marketing asset.'}
                            </p>
                        </div>
                    </div>
                </div>
