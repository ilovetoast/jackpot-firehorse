...
/**
 * Defaults: layer, element, and history open; actions/advanced collapsed. Canvas starts open
 * for document-only context; AssetEditor collapses canvas when a layer becomes selected.
 */
